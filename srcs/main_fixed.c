...
int main(int argc, char **argv)
{
	...
	if (!strcmp(argv[3], "add"))
		printf("double : %f\nfixed  : %f\n\n", (double1 + double2), fixed_to_double(add_fixed(fixed1, &fixed2, FIXED)));
	else if (!strcmp(argv[3], "sub"))
		printf("double : %f\nfixed  : %f\n\n", (double1 - double2), fixed_to_double(sub_fixed(fixed1, &fixed2, FIXED)));
	else if (!strcmp(argv[3], "mul"))
		printf("double : %f\nfixed  : %f\n\n", (double1 * double2), fixed_to_double(mul_fixed(fixed1, &fixed2, FIXED)));
	else if (!strcmp(argv[3], "div"))
		printf("double : %f\nfixed  : %f\n\n", (double1 / double2), fixed_to_double(div_fixed(fixed1, &fixed2, FIXED)));
	return (0);
}
